...
\abstract{The Agile philosophy does not directly address the issue of usability in software. The user's experience is especially important in the field of games. This essay will explore how the use of personas, a user-centred design tool, has the potential to help agile game development teams construct more effectively focused and prioritised user stories, ultimately resulting in providing players with a more enjoyable and engaging experience.}
